...
from backend.db.database import User, Addresses, session
...
class DatabaseManager:
    ...
    Logic is unchanged from the original src/SQL_Alchemy/database_manager.py —
    only the import path changed (now pulls the scoped, env-configurable session
    from backend.db.database instead of src.SQL_Alchemy.database).
    """
